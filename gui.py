...
class Diabetes(QWidget):
    ...
    def report_ui(self):
        ...
        self.report_subhead = QLabel("Model Info.")
    ...
    def clfn(self):
        ...
        self.l4.clear()
        self.l5.clear()
        self.report_subhead.setText("Model details")
        self.model_details.setText("Fill details and press submit to see the result.")
    ...
    def test_input(self) -> None:
        ...
        self.report_subhead.setText("Report card")
